...
- Based on the method extracting principle i was able to use the mock principle. I could patch the [download_subtitle_from_proxy](tests/subtitle_crawler/test_download_subtitles.py#L17) method and provide the appropriate [mockup](tests/subtitle_crawler/fixtures.py#L9).
