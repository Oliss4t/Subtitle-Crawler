...
from subtitle_crawler import OpenSubtitleCrawler
from fixtures import mock_download_result, mock_download_result_wrong, mock_search_result, mock_search_result_wrong, mock_meta_subtitles, mock_success_result_save_json
from utils import CommandResponse
from error_classes import OpenSubtitleSearchError
...
class TestSubtitleCrawler(unittest.TestCase):
    ...
    @patch('subtitle_crawler.openSubtitleCrawler.OpenSubtitleCrawler.download_subtitle_from_proxy')
    ...
    @patch('subtitle_crawler.openSubtitleCrawler.OpenSubtitleCrawler.search_subtitle_from_proxy')
